...
- [ ] 英语水平？没有过4，6级
- [ ] 之前的项目都很小？ 
- [ ] catch后面能不能跟then？ 回答正确，但理解不到位
- [ ] Promise.all 如果不想某个promise失败就退出，怎么操作？ 不大清楚
- [ ] this指向？ 理解有误，认为onClick函数中的this是指向button的
- [ ] 介绍下闭包的概念，用处是什么？场景了解一般
- [ ] 函数节流和防抖，区别和应用场景？基本了解
- [ ] 对模块的理解 ESModule vs CommonJS？ 没学过
- [ ] flex布局？ 用很少，基本不会
- [ ] antDesign和Bootstrap的区别？不算清楚
- [ ] React单向数据流，数据不可变？不算清楚
- [ ] Hooks？了解很一般， 没在项目中实际写过
- [ ] TypeScript？没写过，不了解
